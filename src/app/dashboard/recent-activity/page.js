        ...
        <div>
            <div className="sm:flex sm:items-center mb-8">
                <div className="sm:flex-auto">
                    <h1 className="text-xl font-semibold leading-6 text-gray-900">Recent Activity</h1>
                    <p className="mt-2 text-sm text-gray-700">A timeline of the most recent administrator actions.</p>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <div className="bg-white px-4 py-5 shadow sm:rounded-lg sm:px-6 border border-gray-100">
                    {activities.length === 0 ? (
                                    ...
                                    <li key={activity._id || Math.random()}>
                                        <div className="relative pb-8">
                                            ...
                                            <div className="relative flex space-x-3">
                                                <div>
                                                    <span className={`h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white ${getIconColor(activity.action)}`}>
                                                ...
                                                <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                                                    <div>
                                                        <p className="text-sm text-gray-500">
                                                            ...
                                                            </span> performed <span className="font-medium text-indigo-600">{activity.action}</span>
                                                        </p>
